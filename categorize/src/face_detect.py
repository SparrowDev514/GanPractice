...
l = os.listdir("categorize/dataset/input")
for i in l:
    ...
    if result_dir == "":
        ...
        os.mkdir("categorize/dataset/output/" + result_dir)
        m = os.listdir("categorize/dataset/input/" + i)
        n = 0
        for target_file in m:
            origin_image = ("categorize/dataset/input/" + i + "/" + target_file)
            if origin_image.split(".")[1] == "gitignore":
                ...
                for x, y, w, h in facerect:
                    ...
                    save_path = "categorize/dataset/output/" + result_dir + "/image_" + str(n) + ".png"
