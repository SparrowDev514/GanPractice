...
class WaterDown():
    ...
    @classmethod
    def process(cls, target_image_list: list, is_black: bool, square_size: int) -> list:
        """水増しを行う関数
        ...
        for target_image in target_image_list:
            ...
            # 回転
            rotate_image_list = cls._rotate(resize_image)
            # リストの生成
    ...
    @staticmethod
    def _rotate(target_image: np.ndarray) -> list:
